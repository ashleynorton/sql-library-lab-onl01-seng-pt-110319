...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, series.subgenre_id FROM authors JOIN series ON authors.id = series.author_id INNER JOIN subgenres ON series.subgenres_id = subgenGROUP BY authors.name;"
end
